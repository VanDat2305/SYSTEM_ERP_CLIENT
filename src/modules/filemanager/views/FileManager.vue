          ...
          <div class="absolute top-2 right-2">
            ...
            <transition name="fade">
              <div v-if="activeFileMenu === item.id" @mouseleave="activeFileMenu = null"
                ...
                <div class="py-2">
                  <a v-if="item.type !== 'folder'" href="#" @click="copyId(item.id)"
...
const copyId = async (id: any) => {
  try {
    ...
    notificationService.info(
      t('file_manager.messages.clipboard_copied', [id])
    )
    setTimeout(() => (copiedId.value = null), 5000)
  } catch (err) {
    notificationService.error(t('file_manager.messages.copy_id_failed'))
  }
}
