            ...
            <div>
              ...
              <div class="grid grid-cols-1">
                <button
                  ...
                  {{ $t('signup_page.signup_with_google') }}
                </button>
              </div>
                  ...
                  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      <label for="fname" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        {{ $t('signup_page.first_name') }}<span class="text-error-500">*</span>
                      </label>
                      <input v-model="firstName" type="text" id="fname" name="fname"
                        :placeholder="$t('signup_page.enter_first_name')"
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <input v-model="lastName" type="text" id="lname" name="lname"
