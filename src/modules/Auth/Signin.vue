                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      <label for="email" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        {{ $t('login_page.email') }}<span class="text-error-500">*</span>
                      </label>
                    ...
                    <div>
                      <label for="password" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        {{ $t('login_page.password') }}<span class="text-error-500">*</span>
                      </label>
                      <div class="relative">
                ...
                <div class="mt-5">
                  <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">{{
                    ...
                    <router-link to="/signup" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">{{
                      $t('login_page.sign_up') }}</router-link>
                  </p>
                </div>
              </div>
            </div>
