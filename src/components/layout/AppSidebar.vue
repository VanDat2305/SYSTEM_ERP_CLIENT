<template>
  <aside :class="[
    ...
    <div :class="[
      ...
      <router-link to="/">
        <img v-if="isExpanded || isHovered || isMobileOpen" class="dark:hidden" src="/images/logo/logo-no-dark.png"
          alt="Logo" width="150" height="40" />
        <img v-if="isExpanded || isHovered || isMobileOpen" class="hidden dark:block" src="/images/logo/logo-dark.png"
          alt="Logo" width="150" height="40" />
        <img v-else src="/images/logo/logo.png" alt="Logo" width="32" height="32" />
      </router-link>
    </div>
    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { name: t("menu.roles_permissions"), path: "/system/roles" },
      ...
      },
      {
        ...
        subItems: [
          ...
          // { name: t("menu.payment_gateway"), path: "/settings/payment" },
          // { name: t("menu.webhook_settings"), path: "/settings/webhook" },
        ],
      },
    ],
  },
